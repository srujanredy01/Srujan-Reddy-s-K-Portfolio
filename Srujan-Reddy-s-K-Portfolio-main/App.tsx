...
const projects: ProjectType[] = [
    {
        date: "JUN 2026",
        title: "CampusRules AI (RAG)",
        category: "Artificial Intelligence",
        status: 'Working',
        description: [
            "An AI-powered campus assistant built using Retrieval-Augmented Generation (RAG).",
            "Answers questions from official academic regulations and campus documents through semantic search and vector retrieval."
        ],
        detailedDescription: "An AI-powered campus assistant built using Retrieval-Augmented Generation (RAG). It answers questions using official academic regulations, hostel rules, examination policies, and campus documents through semantic search and vector retrieval.",
        highlights: ["RAG Architecture", "LangChain", "Vector Database", "Semantic Search", "Source Citation", "Document Upload Portal", "Admin Dashboard", "Authentication"],
        tags: ['AI'],
        technologies: ['Python', 'Django', 'PostgreSQL', 'LangChain', 'FAISS', 'Gemini API', 'Docker'],
        liveDemoUrl: '#',
        codeUrl: 'https://github.com/srujanredy01',
        challenges: [
            "Building accurate semantic retrieval over heterogeneous campus documents.",
            "Ensuring responses cite correct source documents with high precision.",
            "Designing a scalable admin portal for document ingestion and management."
        ],
        solutions: [
            { description: "Used FAISS vector database with LangChain for efficient similarity search over embedded document chunks." },
            { description: "Implemented source citation by tracking chunk provenance through the retrieval pipeline." },
            { description: "Built a Django-based admin dashboard with authentication for secure document uploads." }
        ]
    },
    {
        date: "NOV 2025",
        ...
        highlights: ["Study Material Hub", "Semester-wise Navigation", "PDF & Doc Viewer", "Admin Upload Portal", "Resource Search", "Mobile Responsive", "Firebase Auth", "Real-time Database"],
        tags: ['Full Stack'],
    ...
    },
    {
        ...
        status: 'Working',
        description: [
            "A productivity platform that combines task management, habits, expenses, study planning, notes, and analytics into one dashboard.",
            "Designed specifically for students to streamline their daily routines and track long-term goals."
        ],
        detailedDescription: "A productivity platform for students that combines task management, habits, expenses, study planning, notes, focus sessions, calendars, and analytics into one dashboard.",
        highlights: ["Daily Planner", "Habit Tracker", "Expense Tracker", "Study Planner", "Notes", "Focus Timer", "Calendar", "Analytics Dashboard"],
        tags: ['Full Stack'],
        technologies: ['React', 'Django', 'PostgreSQL', 'Docker'],
        liveDemoUrl: '#',
        codeUrl: 'https://github.com/srujanredy01',
        challenges: [
            "Integrating multiple productivity modules into a single cohesive dashboard.",
            "Maintaining real-time sync across planner, habits, and analytics views.",
            "Designing an intuitive UX that doesn't overwhelm users with features."
        ],
        solutions: [
            { description: "Built a modular Django REST API with a React frontend, keeping each feature domain isolated." },
            { description: "Used WebSockets for real-time updates across the calendar and focus timer modules." },
            { description: "Applied progressive disclosure UX patterns to surface features contextually." }
        ]
    },
    {
        date: "JUL 2025",
        ...
        highlights: ["Gemini API Integration", "Rubric-based Scoring", "Automated Feedback", "Teacher Review Mode", "PDF Upload", "Batch Evaluation", "Score Analytics", "Flask Backend"],
        tags: ['AI'],
    ...
    },
    {
        ...
        status: 'Completed',
        description: [
            "A fitness tracking application for logging workouts, monitoring progress, and tracking body weight, calories, and personal records.",
            "Supports long-term fitness goal setting with weekly analytics and BMI calculations."
        ],
        detailedDescription: "A fitness tracking application for logging workouts, monitoring progress, tracking body weight, calories, personal records, and long-term fitness goals.",
        highlights: ["Workout Logger", "Exercise History", "Personal Records", "Weight Tracking", "Goal Tracking", "Progress Charts", "Weekly Analytics", "BMI Calculator"],
        tags: ['Fitness'],
        technologies: ['Django', 'PostgreSQL', 'Chart.js', 'Docker'],
        liveDemoUrl: '#',
        codeUrl: 'https://github.com/srujanredy01',
        challenges: [
            "Designing a flexible data model that supports diverse exercise types and custom routines.",
            "Rendering performance-efficient charts for long-term progress data.",
            "Keeping the logging experience fast and frictionless for daily use."
        ],
        solutions: [
            { description: "Modeled exercises, sets, and reps as normalized Django ORM entities with support for custom workout templates." },
            { description: "Used Chart.js with lazy-loading and data aggregation to keep charts responsive even with large datasets." },
            { description: "Designed a minimal quick-log UI with prefilled last-session data to reduce friction." }
        ]
    },
    {
        date: "DEC 2025",
        ...
        highlights: ["Demand Forecasting", "Feature Engineering", "Ensemble Models", "EDA", "Streamlit Dashboard", "Weather Analysis", "Seasonal Trends", "Model Evaluation"],
    ...
    },
    {
        ...
        highlights: ["FCFS Algorithm", "SSTF Algorithm", "SCAN Algorithm", "C-SCAN Algorithm", "Real-time Visualization", "Seek Time Analysis", "Interactive GUI", "Head Movement Charts"],
...
const allTags = ['All', 'AI', 'Full Stack', 'Data Engineering', 'Machine Learning', 'Fitness'];
...
const ProjectCard: React.FC<ProjectType & { index: number; onSelect: () => void; }> = ({ date, title, category, status, description, highlights, technologies, index, tags, onSelect, liveDemoUrl, codeUrl }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-3">
                ...
                <span className={`flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border transition-all duration-300 group-hover:shadow-sm ${statusColors[status]}`}>
            ...
            <div className="flex items-center gap-2 mb-2">
                <p className="text-indigo-500 font-semibold text-xs tracking-widest uppercase">{date}</p>
                <span className="text-gray-300 text-xs">•</span>
                <span className="bg-indigo-50 text-indigo-600 text-[10px] font-bold px-2 py-0.5 rounded-full border border-indigo-100 uppercase tracking-wider">{category}</span>
            </div>
            ...
            {/* Description */}
            <div className="relative flex-grow min-h-[80px] mb-4">
                <ul className="space-y-1.5 list-disc list-inside text-sm text-gray-600 leading-relaxed transition-opacity duration-300 md:group-hover:opacity-0">
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                    {highlights.slice(0, 6).map(h => (
                        <span key={h} className="bg-gray-50 text-gray-600 text-[10px] font-semibold px-2 py-0.5 rounded-full border border-gray-100">{h}</span>
                    ))}
                    {highlights.length > 6 && (
                        <span className="bg-gray-50 text-gray-400 text-[10px] font-semibold px-2 py-0.5 rounded-full border border-gray-100">+{highlights.length - 6} more</span>
                    )}
                </div>
            </div>
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {technologies.map(tech => (
                        <span key={tech} className="bg-indigo-50 text-indigo-700 text-xs font-semibold px-2.5 py-1 rounded-full border border-indigo-100 flex items-center gap-1">
                            {skillIcons[tech] ? <span className="scale-75 inline-flex" aria-hidden="true">{skillIcons[tech]}</span> : null}
                            {tech}
                        </span>
                    ))}
                </div>
            ...
            <div className="mt-auto pt-4 border-t border-gray-100 flex items-center gap-3">
                {codeUrl !== '#' && (
                    <a href={codeUrl} onClick={(e) => e.stopPropagation()} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-bold text-gray-700 bg-white border border-gray-200 rounded-full hover:bg-gray-100 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                        <GithubIcon className="w-3.5 h-3.5" aria-hidden="true" />
                        GitHub
                    </a>
                )}
                {liveDemoUrl !== '#' && (
                    <a href={liveDemoUrl} onClick={(e) => e.stopPropagation()} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-bold text-white bg-gray-900 rounded-full hover:bg-gray-700 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                        <ExternalLinkIcon className="w-3.5 h-3.5" aria-hidden="true" />
                        Live Demo
                    </a>
                )}
                {liveDemoUrl === '#' && codeUrl === '#' && (
                    <span className="text-indigo-600 font-semibold text-sm group-hover:text-indigo-800 transition-colors flex items-center justify-center gap-2 w-full">
                        View Details
                        <ArrowRightIcon className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                    </span>
                )}
                {(liveDemoUrl !== '#' || codeUrl !== '#') && (
                    <button onClick={(e) => { e.stopPropagation(); onSelect(); }} className="text-indigo-500 hover:text-indigo-700 transition-colors p-2 rounded-full hover:bg-indigo-50" aria-label="View project details">
                        <ArrowRightIcon className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                    </button>
                )}
            </div>
...
const CertificateModal: React.FC<{ certificate: QualificationType | null; onClose: () => void; }> = ({ certificate, onClose }) => {
    const [isVisible, setIsVisible] = useState(false);
    const modalRef = useRef<HTMLDivElement>(null);
        ...
        >
            ...
            >
                ...
                <div className="p-6 sm:p-8">
                    ...
                    <p className="text-gray-500 mb-6 font-medium">Issued: {certificate.date}</p>
                    <div className="flex flex-wrap gap-4">
                        <a 
                            href={certificate.verifyUrl} 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-bold rounded-full hover:bg-indigo-700 transition-all shadow-lg hover:-translate-y-1"
                        >
                            Verify Credential
                            <ExternalLinkIcon className="w-5 h-5" />
                        </a>
                        <button 
                            onClick={onClose}
                            className="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 font-bold rounded-full hover:bg-gray-200 transition-all"
                        >
                            Close
                        </button>
                    </div>
...
const ProjectShowcase: React.FC<{ activeProject: ProjectType | null; onClose: () => void }> = ({ activeProject, onClose }) => {
    const displayProject = activeProject || projects[0];

    return (
        <section id="showcase" className="py-24 bg-white/30 backdrop-blur-sm rounded-[3rem] border border-white/50 my-20 relative">
            <button 
                onClick={onClose}
                className="absolute top-8 right-8 p-3 bg-white/80 hover:bg-white rounded-full border border-white/50 shadow-lg transition-all hover:scale-110 z-10 group"
                aria-label="Close showcase"
            >
                <XIcon className="w-6 h-6 text-gray-500 group-hover:text-gray-900" />
            </button>
                ...
                <div className="space-y-32">
                    {displayProject && (
                        <div 
                            ...
                            id={`project-${displayProject.title.toLowerCase().replace(/\s+/g, '-')}`}
                            className="flex flex-col lg:flex-row gap-12 items-start scroll-mt-32 animate-in fade-in slide-in-from-bottom-8 duration-700"
                        >
                            {/* Project Info */}
                            <div className="lg:w-1/2 space-y-6">
                                <div className="flex items-center gap-4">
                                    <span className="text-indigo-500 font-bold tracking-widest uppercase text-sm">{displayProject.date}</span>
                                    <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border shadow-sm ${
                                        displayProject.status === 'Live' ? 'bg-emerald-50 text-emerald-700 border-emerald-200' :
                                        displayProject.status === 'Completed' ? 'bg-blue-50 text-blue-700 border-blue-200' :
                                        'bg-amber-50 text-amber-700 border-amber-200'
                                    }`}>{displayProject.status}</span>
                                </div>
                                <h3 className="text-3xl md:text-5xl font-black text-gray-900">{displayProject.title}</h3>
                                <p className="text-lg text-gray-600 leading-relaxed">{displayProject.detailedDescription}</p>
                                ...
                                <div className="flex flex-wrap gap-4 pt-4">
                                    {displayProject.liveDemoUrl !== '#' && (
                                        <a href={displayProject.liveDemoUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-full font-bold hover:bg-gray-700 transition-all shadow-lg hover:-translate-y-1">
                                            <ExternalLinkIcon className="w-5 h-5" />
                                            Live Demo
                                        </a>
                                    )}
                                    {displayProject.codeUrl !== '#' && (
                                        <a href={displayProject.codeUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-white text-gray-900 border border-gray-200 px-6 py-3 rounded-full font-bold hover:bg-gray-50 transition-all shadow-md hover:-translate-y-1">
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <ul className="space-y-3">
                                            {displayProject.challenges.map((challenge, i) => (
                                    ...
                                    <div className="pt-8 border-t border-gray-100">
                                        ...
                                        <ul className="space-y-4">
                                            {displayProject.solutions.map((solution, i) => (
...
const App: React.FC = () => {
    ...
    const navLinks = ["About", "Stats", "Skills", "Projects", ...(selectedProject ? ["Showcase"] : []), "Experience", "Achievements", "Resume", "Contact"];
    const [selectedSkill, setSelectedSkill] = useState<SkillDetail | null>(null);
    const [selectedAchievement, setSelectedAchievement] = useState<AchievementType | null>(null);
    const [selectedCertificate, setSelectedCertificate] = useState<QualificationType | null>(null);
    ...
    const handleProjectSelect = (p: ProjectType) => {
        ...
        // Use a small timeout to ensure the DOM has updated and the section is rendered
        setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 antialiased relative overflow-hidden">
            ...
            <header ref={headerRef} className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-fit max-w-[95vw]">
                <nav className="bg-white/70 backdrop-blur-3xl rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-white/50 px-6 py-2.5 md:px-8">
                    <div className="flex items-center justify-center gap-6 md:gap-2">
                        ...
                        <ul className="hidden md:flex items-center gap-1">
                            <li className="w-px h-6 bg-gray-200 mx-4" aria-hidden="true"></li>
                            {navLinks.map(link => {
                    ...
                    <div 
                        id="mobile-menu"
                        className={`
                        md:hidden absolute top-[calc(100%+1rem)] left-1/2 -translate-x-1/2 w-[85vw] max-w-sm bg-white/90 backdrop-blur-3xl rounded-[2rem] border border-white/50 shadow-2xl transition-all duration-500 ease-in-out overflow-hidden
                        ${isMenuOpen ? 'max-h-[500px] opacity-100 py-8 translate-y-0' : 'max-h-0 opacity-0 py-0 -translate-y-4'}
                    `}>
            ...
            <main id="main-content" className="container mx-auto px-4 pt-24 md:pt-32 pb-16 relative z-10">
                ...
                <section id="projects" className="py-12 sm:py-20">
                    <div className="text-center mb-12 sm:mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mt-2">Featured Projects</h2>
                    </div>
                ...
                {selectedProject && (
                    <div className="animate-in fade-in zoom-in-95 duration-500">
                        <ProjectShowcase activeProject={selectedProject} onClose={() => setSelectedProject(null)} />
                    </div>
                )}
                                    ...
                                    <div key={q.name} className="p-6 bg-white rounded-2xl border border-gray-200 hover:shadow-xl hover:border-indigo-300/50 hover:-translate-y-1 transition-all duration-300 group flex flex-col relative overflow-hidden">
                                        ...
                                        <div className="flex-grow relative z-10">
                                         ...
                                         <div className="mt-6 relative z-10">
                                            {q.verifyUrl !== '#' ? (
                                                <button 
                                                    onClick={() => setSelectedCertificate(q)}
